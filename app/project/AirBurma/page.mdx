export const metadata = {
  title: 'AirBurma Web Application',
  description:
...
# A flight booking management platform designed for Travel Agencies 

AirBurma is a digital platform designed to enhance the core competencies and support the professional growth of travel agency staff.

In developing the digital platform, the UX design team’s primary responsibilities were comprised of two challenges...


<Cover
  src="/AirBurma-IMG01.jpg"
  alt="Dashboard UI design from AirBurma web app"
  caption=""
/>
...
<Cover
  src="/AirBurma-IMG02.jpg"
  alt="Search flight UI design from AirBurma web app"
  caption="Search flight UI page"
/>
